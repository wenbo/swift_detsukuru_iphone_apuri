...
class FirstViewController: UIImagePickerController, UINavigationControllerDelegate, UIImagePickerControllerDelegate, UICollectionViewDelegate {
    ...
    */
    ...
    /// 画質を設定画面とやりとるするときのキー文字列
    let pictureQualityKey = "pictureQuality"
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        var pictureQuality = userDefaults.integerForKey(pictureQualityKey)
        
        println("画質設定：\(pictureQuality)")
        
        switch pictureQuality {
        case picQuarityType.small.hashValue:
            self.picQuarity = picQuarityType.small
            
        case picQuarityType.medium.hashValue:
            self.picQuarity = picQuarityType.medium
            
        case picQuarityType.large.hashValue:
            self.picQuarity = picQuarityType.large
            
        case picQuarityType.original.hashValue:
            self.picQuarity = picQuarityType.original
