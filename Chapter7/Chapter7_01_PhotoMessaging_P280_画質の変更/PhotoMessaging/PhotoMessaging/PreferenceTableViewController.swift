...
class PreferenceTableViewController: UITableViewController, UIActionSheetDelegate {
    ...
    let pictureQuality = "pictureQuality"
    ...
    */
    func actionSheet(actionSheet: UIActionSheet, clickedButtonAtIndex buttonIndex: Int) {
        ...
        if buttonIndex != actionSheet.cancelButtonIndex{
            ...
            defaults.setInteger(buttonIndex, forKey: pictureQuality)
        }
    }
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let defaults = NSUserDefaults.standardUserDefaults()
        let quality = defaults.integerForKey(self.pictureQuality)
        
        cell.detailTextLabel!.text = self.titles[quality]
